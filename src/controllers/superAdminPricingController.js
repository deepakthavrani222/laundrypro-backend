...
class SuperAdminPricingController {
  // Get all pricing configurations
  async getPricingConfigurations(req, res) {
    try {
      console.log('📦 getPricingConfigurations - Starting...')
      console.log('📦 Admin:', req.admin ? { id: req.admin._id, email: req.admin.email, permissions: req.admin.permissions } : 'NO ADMIN')
      ...
      // Note: createdBy/approvedBy may reference either CenterAdmin or SuperAdmin
      // We'll skip populate for now to avoid errors with mixed references
      ...
      console.log('📦 Found configs:', pricingConfigs.length)
...
module.exports = new SuperAdminPricingController()
