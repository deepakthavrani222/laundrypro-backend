...
// @desc    Assign complaint to support agent
...
const assignComplaint = asyncHandler(async (req, res) => {
  ...
  if (!agent) {
    return sendError(res, 'INVALID_AGENT', 'Invalid support agent', 400);
  }
...
// @desc    Get support agents for assignment
...
const getSupportAgents = asyncHandler(async (req, res) => {
  ...
  sendSuccess(res, { agents }, 'Support agents retrieved successfully');
});
